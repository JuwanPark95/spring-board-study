...
public class BoardDaoImpl implements BoardDao{
	...
	public List<BoardVo> boardSelectList(HashMap<String, Object> hMap) {
		// TODO Auto-generated method stub
		return sqlSession.selectList("board.boardSelectList",hMap);
	}
	@Override
	public int boardSelectCnt(String string) {
		// TODO Auto-generated method stub
		return sqlSession.selectOne("board.boardSelectCnt",string);
	}
	@Override
	public List<BoardVo> boardAllBoardType() {
		// TODO Auto-generated method stub
		return sqlSession.selectList("board.boardAllSelectType");
	}
